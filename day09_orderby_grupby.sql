...
FROM insanlar
WHERE isim IS NULL;
-- Ismi NULL olanlari isimsiz yapin
UPDATE insanlar
SET isim = 'isimsiz'
WHERE isim IS NULL;
-- Ismi Null olanalari silin
...
SELECT isim, SUM(urun_miktar) AS top_kilo
FROM manav
GROUP BY isim
ORDER BY isim;

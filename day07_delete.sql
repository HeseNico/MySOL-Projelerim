...
DELETE FROM cucuklar
WHERE veli_isim IN ('Ali','Ayse'); -- kolay yol
-- Yazili notu 84'ten buyuk olan cocuklari silin
DELETE FROM cucuklar
WHERE yazili_notu > 84;
-- Yazili notu 85'ten farkli olan cocuklari silin
DELETE FROM cucuklar
WHERE yazili_notu != 85; -- COZUM 1
DELETE FROM cucuklar
WHERE NOT yazili_notu = 85; -- COZUM 2
DELETE FROM cucuklar
WHERE yazili_notu <> 85; -- COZUM 3    85'ten buyuk yada kucuk olanlarin disindakileri siler (<>)
use sys;
DELETE FROM ogrenciler;     -- Tum verileri sil.
--    SAVEPOINT ABC;     -- Verilen konuma kodlari kaydeder.
--    ROLLBACK TO  ABC;  -- Silinen Verileri geri getir.
...
DELETE FROM cocuk
WHERE id > 124;
ROLLBACK TO cicek; -- bu satirda sildigimiz verileri kaydettigimiz alandan geri cagiririyoruz
